  ...
  useEffect(() => {
    ...
    var myChart = new Chart(chartOne, {
      ...
      data: {
        ...
        datasets: [
          {
            label: "Sell of Product",
            data: [12, 16, 5, 24, 20, 39, 10, 15, 21, 26, 17, 9],
            backgroundColor: [
              "rgba(255, 99, 132, 0.2)",
              "rgba(54, 162, 235, 0.2)",
              "rgba(255, 206, 86, 0.2)",
      ...
      <div class="w-full flex-grow p-6">
        ...
        <div class="flex flex-wrap -mx-3 mb-20">
          ...
          <div class="w-1/2 xl:w-1/4 px-3">
            <div class="w-full bg-white border text-blue-400 rounded-lg flex items-center p-6">
              ...
              <div class="text-gray-700">
                <p class="font-semibold text-3xl">93</p>
                <p>This Month Sold</p>
              </div>
            </div>
          </div>
        ...
        <div class="flex flex-wrap mt-6">
          <div class="w-full lg:w-1/2 pr-0 lg:pr-2">
            <p class="text-xl pb-3 flex items-center">Sell of Product</p>
            <div class="p-6 bg-white">
              <canvas id="chartOne" width="400" height="200"></canvas>
            </div>
          </div>
          <div class="w-full lg:w-1/2 pl-0 lg:pl-2 mt-12 lg:mt-0">
            <p class="text-xl pb-3 flex items-center">Sell of Money</p>
            <div class="p-6 bg-white">
        ...
        <div class="w-full mt-12">
          <p class="text-xl pb-3 flex items-center">Recent Order</p>
